...
public class Student {
     ...
     * @param stuAge  学生年龄
     */
    public Student(String stuName, String stuId, String stuSex, int stuAge) {
    ...
    /**
     * set 设置学生性别，对性别进行判断，如果输入的不是（男|女），就给性别默认设置为（男）
     *
     * @param stuSex 学生性别
     */
     ...
     * 输出学生详细信息
     *
     * @return 学生详细信息（学生姓名、学生学号、学生性别、学生年龄）
     */
    public String showStuInformation() {
        return "==================================="
                + "\n学生信息如下:"
                + "\n姓名: " + this.getStuName()
                + "\n学号: " + this.getStuId()
